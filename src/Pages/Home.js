...
function Home() {
    ...
    console.log("this is the product list from home ",productList)
                    ...
                    <div className="container">
                        <div className="row service-block">
                            ...
                            <div className="col-lg-3 col-md-6  col-sm-12">
                                <div className="media">
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 417.12 417.12" style={{ enableBackground: "new 0 0 417.12 417.12" }} xmlSpace="preserve">
                                        <g>
                                            <g>
                          ...
                          c2.877-2.141,4.425-5.63,4.08-9.2C339.301,228.744,337.319,224.811,333.76,222.901z M289.36,220.581h-45.84l45.84-61.92V220.581z"
                            ...
                            <div className="col-lg-3 col-md-6  col-sm-12 ">
                                <div className="media">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 295.82 295.82" xmlnsXlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 295.82 295.82">
                                        <g>
                                            <g>
                            ...
                            <div className="col-lg-3 col-md-6  col-sm-12 ">
                                <div className="media">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 448 448" style={{ enableBackground: "new 0 0 448 448" }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                                <g>
